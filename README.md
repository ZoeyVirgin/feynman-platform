...
# ===== 千帆 Embedding 配置（RAG 向量检索）=====
# 方式一：使用 v2 API（推荐）
QIANFAN_V2_API_KEY=your_qianfan_api_key
QIANFAN_V2_EMBEDDING_ENDPOINT=https://qianfan.baidubce.com/v2/embeddings
QIANFAN_V2_MODEL=embedding-v1
...
RAG_AUTO_REBUILD_ON_START=true
